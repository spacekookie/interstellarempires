		...
		server.addListener(new Listener() {
			...
			public void received(Connection c, Object obj) {
				...
				if (obj instanceof ConnectionPackage) {
					...
					/**
					 * Extracts information from the Connection Package and
					 * checks if the player is registered on the server. If it
					 * isn't an empty package is being sent back
					 * 
					 * TODO: Check in server database if a player is registered
					 * with the server. So far every player with any password is
					 * accepted.
					 */
					...
					// ((ConnectionPackage)
					// obj).setServerKeyResponse("Ergosphere".hashCode());
					// ((ConnectionPackage)
					// obj).setServerNameResponse("Ergosphere");
