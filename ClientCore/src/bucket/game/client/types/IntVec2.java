...
/**
 * My own integer implementation of the Vector2 class from libgdx.
 * 
 * @author ***REMOVED***
 * 
 */
public class IntVec2 {
	 ...
	 * @return This vector for chaining
	 */
	public IntVec2 mul(int x, int y) {
		this.x *= x;
		this.y *= y;
		return this;
	}
	 ...
	 * @return This vector for chaining
	 */
	public IntVec2 sub(float x, float y) {
		this.x -= x;
		this.y -= y;
		return this;
	}
	 ...
	 * @return this vector
	 */
	public IntVec2 mul(Matrix3 mat) {
	 ...
	 * @return the cross product
	 */
	public float crosss(int x, int y) {
