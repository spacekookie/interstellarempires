...
/**
 * Counterpart to the @HexMap. Will display a solarsystem to the player. Extending the
 * Group instead of the Actor to hold own Actor instances
 * 
 * @author ***REMOVED***
 * 
 */
public class SolarMap extends Group implements Disposable {
	...
	public void draw(SpriteBatch batch, float parentAlpha) {
		...
		renderer.circle(500, 400, system.getRadius()); // TODO: Get solarsystem radius
