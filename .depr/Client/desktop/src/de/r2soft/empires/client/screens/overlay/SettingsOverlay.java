...
public class SettingsOverlay extends R2Overlay {
	...
	public void build() {
		...
		/* Credit Names */
		katharina = new Label("Katharina Fey", Assets.R2_UI_SKIN);
		...
		primary.add(apply).height(Values.R2_UI_SIZES_BUTTON_HEIGHT_PRIME)
				.padTop(Values.R2_UI_PIXEL_PAD_MEDIUM).width(Values.R2_UI_SIZES_BUTTON_WIDTH_PRIME);
		primary.add(back).height(Values.R2_UI_SIZES_BUTTON_HEIGHT_PRIME)
				.padTop(Values.R2_UI_PIXEL_PAD_MEDIUM).width(Values.R2_UI_SIZES_BUTTON_WIDTH_PRIME);
