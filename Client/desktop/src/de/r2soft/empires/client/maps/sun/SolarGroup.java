...
public class SolarGroup extends Group {
  ...
  public void draw(SpriteBatch batch, float parentAlpha) {
	...
	shapeRenderer.circle((Gdx.graphics.getWidth() / 2) + offsetX, Gdx.graphics.getHeight() / 2, system.getRadius());
	shapeRenderer.circle((Gdx.graphics.getWidth() / 2) + offsetX, Gdx.graphics.getHeight() / 2, system.getRadius() + 25);
	shapeRenderer.end();
	batch.begin();
