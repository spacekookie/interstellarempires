 ...
 * planets orbiting on circular paths around the star.
 * 
 * @author Katharina
 * 
 */
public class SolSystemRenderer implements MapRenderer, Disposable {
	...
	@Override
	public void setView(Matrix4 projection, float x, float y, float width,
			float height) {
	...
	public void render() {
		...
		batch.draw(Resources.STARS_RED_DWARF, Find.getCenter().x
				- (Sizes.SIZE_CELESTIAL_RED_DWARF / 2), Find.getCenter().y
				- (Sizes.SIZE_CELESTIAL_RED_DWARF / 2), 0, 0,
				Sizes.SIZE_CELESTIAL_RED_DWARF, Sizes.SIZE_CELESTIAL_RED_DWARF,
				1, 1, 0);
		batch.end();
	}
