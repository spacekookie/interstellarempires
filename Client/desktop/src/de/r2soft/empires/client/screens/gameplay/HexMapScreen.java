...
/**
 * Re-Make of the main menu screen with new camera view port and UI. Published for Prototype version
 * 1.2
 * 
 * @author Katharina
 * 
...
public class HexMapScreen extends R2Screen {
	...
	public void render(float delta) {
		...
		shapeRenderer.rect(Values.HEX_MAP_BASE_OFFSET.x, Values.HEX_MAP_BASE_OFFSET.y,
				Values.HEX_MAP_BASE_SIZE.x, Values.HEX_MAP_BASE_SIZE.y);
		shapeRenderer.end();

		/** Sets up map view */
		Gdx.gl.glViewport(Values.HEX_MAP_BASE_OFFSET.x, Values.HEX_MAP_BASE_OFFSET.y,
				Values.HEX_MAP_BASE_SIZE.x, Values.HEX_MAP_BASE_SIZE.y);
	...
	private void setupListeners() {
		...
		profile.addListener(new ClickListener() {
			...
			public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
				...
				profileDialog.setPosition((Values.NEW_WIDTH / 2) - (Values.NEW_WIDTH / 4),
						(Values.NEW_HEIGHT / 2) - (Values.NEW_HEIGHT / 4));
	...
	private void setupLayout() {
		...
		selectorTable
				.setPosition(Values.HEX_MAP_BASE_OFFSET.x + 300, Values.HEX_MAP_BASE_OFFSET.y - 10);
