...
public class SettingsOverlay extends R2Overlay {
  ...
  public void build() {
	...
	/* Credit Names */
	katharina = new Label("Katharina Fey", Assets.UI_SKIN);
	leander = new Label("Leander Sabel", Assets.UI_SKIN);
	steve = new Label("Steve Sancteria", Assets.UI_SKIN);
	julie = new Label("Julie Rae-Clarke", Assets.UI_SKIN);
