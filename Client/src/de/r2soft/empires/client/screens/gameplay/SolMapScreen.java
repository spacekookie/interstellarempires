...
/**
 * Remake of the solar system screen with new camera viewport and UI. Published for Prototype
 * version 1.2
 * 
 * @author Katharina
 * 
...
public class SolMapScreen extends R2Screen {
	...
	public void render(float arg0) {
		...
		Gdx.gl.glViewport(Values.SOL_MAP_BASE_OFFSET.x, Values.SOL_MAP_BASE_OFFSET.y,
